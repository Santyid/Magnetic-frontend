...
/**
 * Magnetic Design System - Icon Library
 * All icons use: fill="none", stroke="currentColor", strokeWidth={1.66667}
...
function icon(paths: React.ReactNode, displayName: string) {
  const Icon = ({ size = 'md', className = '' }: IconProps) => (
    <svg
      className={[sizeMap[size], className].join(' ')}
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
    >
...
export const IconChevronDown = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M19.5 8.25l-7.5 7.5-7.5-7.5" />,
  'IconChevronDown'
);

export const IconChevronRight = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M8.25 4.5l7.5 7.5-7.5 7.5" />,
  'IconChevronRight'
);

export const IconChevronLeft = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M15.75 19.5L8.25 12l7.5-7.5" />,
  'IconChevronLeft'
);

export const IconChevronUp = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M4.5 15.75l7.5-7.5 7.5 7.5" />,
  'IconChevronUp'
);

export const IconArrowLeft = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />,
  'IconArrowLeft'
);

export const IconArrowRight = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />,
  'IconArrowRight'
);
...
export const IconPlus = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M12 4.5v15m7.5-7.5h-15" />,
  'IconPlus'
);

export const IconMinus = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M19.5 12h-15" />,
  'IconMinus'
);

export const IconClose = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M6 18L18 6M6 6l12 12" />,
  'IconClose'
);

export const IconCheck = icon(
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={SW} d="M4.5 12.75l6 6 9-13.5" />,
  'IconCheck'
);
